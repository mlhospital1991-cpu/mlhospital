                ...
                <div className="bg-white p-10 md:p-14 rounded-[40px] border border-slate-100 shadow-xl shadow-slate-200/40 relative group overflow-hidden">
                  ...
                  <div className="relative z-10 text-center max-w-2xl mx-auto">
                    <div className="flex flex-col items-center gap-6">
                      <div className="flex gap-1 bg-amber-50 px-4 py-1.5 rounded-full border border-amber-100/50 mb-4">
                        {[...Array(5)].map((_, i) => (
                          <Star
                            key={i}
                            size={14}
                      ...
                      <p className="text-slate-700 text-xl md:text-2xl leading-relaxed italic mb-8 font-medium">
                      ...
                      <div className="flex flex-col items-center gap-4">
                        <div className="flex items-center gap-2">
                          ...
                          <div className="w-5 h-5 bg-blue-500 rounded-full flex items-center justify-center text-white" title="Verified Reviewer">
                        ...
                        <div className="flex items-center gap-4 text-slate-400">
                          <div className="flex items-center gap-2 bg-slate-50 px-3 py-1 rounded-lg border border-slate-100">
                            ...
                            <span className="text-[10px] font-black uppercase tracking-[0.25em] text-slate-500">Google Verified</span>
                          </div>
                          <span className="w-1.5 h-1.5 rounded-full bg-slate-200" />
                          <span className="text-sm font-bold text-slate-400">{reviews[currentIndex].relativeTime}</span>
                        </div>
                      </div>
                    </div>
                  </div>
